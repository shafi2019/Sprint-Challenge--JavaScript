...
'Sultan Salahuddin Abdul Aziz Shah Polytechnic', 'Fachhochschule Rosenheim, Hochschule für Technik und Wirtschaft', 'Salem University',
 'Coastal Carolina University', 'Universidad Católica de Ávila', 'Universitat Rovira I Virgili Tarragona'];
...
const uni = [];
graduates.forEach(graduate =>{ if (graduate.university.includes('Uni'))
...
*/
const lowerPopulation = zooAnimals.filter((lessPopulation) => {
  return lessPopulation.population < 5;
});
...
*/
const populationTotal = zooAnimals.reduce((total, populations) => {
  return total += populations.population;
}, 0);
